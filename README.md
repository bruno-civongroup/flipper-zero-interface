...
**Live:** [projects.brunomalnovic.com/flipper](https://projects.brunomalnovic.com/flipper)
...
No build step. Open `flipper/index.html` directly or serve with any static server:

```bash
cd flipper && npx serve .
```
